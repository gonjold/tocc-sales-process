  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8 flex items-start gap-3">
        ...
        <div>
          <h5 className="font-bold text-blue-900 mb-1">How to Use This System</h5>
          <p className="text-sm text-blue-800">Navigate using the sidebar menu. Each step includes scripts, tips, and relevant documents. Use the Downloads button to get the full training guide.</p>
        </div>
      </div>
