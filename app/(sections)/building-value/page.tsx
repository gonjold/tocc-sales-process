...
const programs = [
  ...
  },
  {
    ...
    color: '#16A34A',
    bgColor: '#DCFCE7',
    description: 'Comprehensive appearance protection for your investment.',
    ...
    talkingPoints: [
      'Protects exterior paint from chips, scratches, and environmental damage',
      'Interior protection against stains and wear',
      'Paintless dent repair for minor dents up to 4 inches',
      'Covers windshield chip repair',
    ],
  },
  {
    id: 'tss',
